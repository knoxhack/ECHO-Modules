# ECHO: CreatureCore Artifact Notes

This file documents the release outputs expected for `echocreaturecore` version `1.0.0`.
...
| `echocreaturecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
