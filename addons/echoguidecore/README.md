...
Provides `guide.pages`, `guide.search`, `guide.unlock_visibility` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoguidecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `guide_core` |
...
Provides: `guide.pages`, `guide.search`, `guide.unlock_visibility`
...
```sh
node scripts/generate-module-release.mjs --module echoguidecore
```
