# ECHO: NPCore Artifact Notes

This file documents the release outputs expected for `echonpcore` version `1.0.0`.
...
| `echonpcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
