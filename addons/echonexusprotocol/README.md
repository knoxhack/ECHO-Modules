...
Provides `nexus.content`, `nexus.endings`, `nexus.field_telemetry`, `nexus.machines`, `nexus.progression`, `nexus.reality_field` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echonexusprotocol` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echoorbitalremnants`, `echorendercore`, `echosoundcore`, `echoterminal`

Provides: `nexus.content`, `nexus.endings`, `nexus.field_telemetry`, `nexus.machines`, `nexus.progression`, `nexus.reality_field`
...
| File | Requirement |
| --- | --- |
| `echonexusprotocol-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echonexusprotocol-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echonexusprotocol-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echonexusprotocol-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echonexusprotocol
```
