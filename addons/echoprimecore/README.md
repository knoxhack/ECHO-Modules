...
Provides `prime.content`, `prime.integrations`, `prime.missions`, `prime.onboarding`, `prime.routes`, `prime.survival`, `prime.world_signals` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoprimecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `pack_root` |
...
Optional modules: `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echoterminal`, `echothemecore`, `echoworldcore`

Provides: `prime.content`, `prime.integrations`, `prime.missions`, `prime.onboarding`, `prime.routes`, `prime.survival`, `prime.world_signals`
...
| File | Requirement |
| --- | --- |
| `echoprimecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoprimecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoprimecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoprimecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoprimecore
```
