# ECHO: SocialCore Artifact Notes

This file documents the release outputs expected for `echosocialcore` version `1.0.0`.
...
| `echosocialcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
