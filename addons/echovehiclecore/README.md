...
Optional modules: `echocameracore`, `echoinputcore`, `echorendercore`, `echosoundcore`

Provides: `vehicle.fuel`, `vehicle.hooks`, `vehicle.profiles`, `vehicle.storage`
...
```sh
node scripts/generate-module-release.mjs --module echovehiclecore
```
