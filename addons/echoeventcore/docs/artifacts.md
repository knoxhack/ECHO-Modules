# ECHO: EventCore Artifact Notes

This file documents the release outputs expected for `echoeventcore` version `1.0.0`.
...
| `echoeventcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
