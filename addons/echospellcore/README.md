...
Provides `spell.aether_costs`, `spell.cooldowns`, `spell.deck`, `spell.definitions`, `spell.focus`, `spell.hud_diagnostics`, `spell.projectiles`, `spell.runtime_hooks` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echospellcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Required modules: `echoadaptercore`, `echoarcanacore`, `echocore`, `echonetcore`

Optional modules: `echoarcaneindex`, `echocursecore`, `echogrimoire`, `echolens`, `echomissioncore`, `echoritualcore`, `echoterminal`

Provides: `spell.aether_costs`, `spell.cooldowns`, `spell.deck`, `spell.definitions`, `spell.focus`, `spell.hud_diagnostics`, `spell.projectiles`, `spell.runtime_hooks`

Consumes: `arcana.core`, `echo.core`, `echo.net`
...
| File | Requirement |
| --- | --- |
| `echospellcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echospellcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echospellcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echospellcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echospellcore
```
