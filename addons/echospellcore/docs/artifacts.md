# ECHO: SpellCore Artifact Notes

This file documents the release outputs expected for `echospellcore` version `1.0.0`.
...
| `echospellcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
