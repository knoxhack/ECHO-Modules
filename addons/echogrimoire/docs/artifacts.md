# ECHO: Grimoire Artifact Notes

This file documents the release outputs expected for `echogrimoire` version `1.0.0`.
...
| `echogrimoire-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
