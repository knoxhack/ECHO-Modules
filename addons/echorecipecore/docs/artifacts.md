# ECHO: RecipeCore Artifact Notes

This file documents the release outputs expected for `echorecipecore` version `1.0.0`.
...
| `echorecipecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
