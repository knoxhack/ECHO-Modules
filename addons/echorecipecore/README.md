...
Provides `index.recipe_backend`, `recipes.backend`, `recipes.machine_views`, `recipes.search`, `recipes.usage_graph` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echorecipecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `recipe_core` |
...
Provides: `index.recipe_backend`, `recipes.backend`, `recipes.machine_views`, `recipes.search`, `recipes.usage_graph`
...
| File | Requirement |
| --- | --- |
| `echorecipecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echorecipecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echorecipecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echorecipecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echorecipecore
```
