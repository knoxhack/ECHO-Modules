# ECHO: ModuleGraph Artifact Notes

This file documents the release outputs expected for `echomodulegraph` version `1.0.0`.
...
| `echomodulegraph-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
