...
Provides `multiblock.automation`, `multiblock.build_assist`, `multiblock.definitions`, `multiblock.facility_runtime`, `multiblock.progression`, `multiblock.validation` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echomultiblockcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `tech` |
...
Optional modules: `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echopowergrid`, `echorendercore`, `echoruntimeguard`, `echoterminal`, `echothemecore`

Provides: `multiblock.automation`, `multiblock.build_assist`, `multiblock.definitions`, `multiblock.facility_runtime`, `multiblock.progression`, `multiblock.validation`
...
| File | Requirement |
| --- | --- |
| `echomultiblockcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echomultiblockcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echomultiblockcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echomultiblockcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echomultiblockcore
```
