# ECHO: MultiblockCore Artifact Notes

This file documents the release outputs expected for `echomultiblockcore` version `1.0.0`.
...
| `echomultiblockcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
