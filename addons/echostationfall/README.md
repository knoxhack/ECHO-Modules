...
Provides `stationfall.ambience`, `stationfall.logs`, `stationfall.routes`, `stationfall.story`, `stationfall.suits` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echostationfall` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echoblackboxprotocol`, `echoholomap`, `echoindex`, `echosoundcore`, `echoterminal`

Provides: `stationfall.ambience`, `stationfall.logs`, `stationfall.routes`, `stationfall.story`, `stationfall.suits`
...
| File | Requirement |
| --- | --- |
| `echostationfall-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echostationfall-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echostationfall-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echostationfall-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echostationfall
```
