# ECHO: Stationfall Artifact Notes

This file documents the release outputs expected for `echostationfall` version `1.0.0`.
...
| `echostationfall-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
