# ECHO: Arcana Core Artifact Notes

This file documents the release outputs expected for `echoarcanacore` version `1.0.0`.

## Artifact Matrix

| File | Requirement |
| --- | --- |
| `echoarcanacore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoarcanacore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoarcanacore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoarcanacore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
| `echoarcanacore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
