...
Optional modules: `echodatacore`, `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echonetcore`, `echoterminal`

Provides: `arcana.core`, `arcana.aether`, `arcana.providers`
...
```sh
node scripts/generate-module-release.mjs --module echoarcanacore
```
