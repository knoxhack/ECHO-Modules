# ECHO: EncounterCore Artifact Notes

This file documents the release outputs expected for `echoencountercore` version `1.0.0`.
...
| `echoencountercore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
