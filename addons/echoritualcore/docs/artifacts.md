# ECHO: RitualCore Artifact Notes

This file documents the release outputs expected for `echoritualcore` version `1.0.0`.
...
| `echoritualcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
