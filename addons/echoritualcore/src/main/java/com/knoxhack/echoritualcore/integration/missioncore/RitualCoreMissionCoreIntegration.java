...
public final class RitualCoreMissionCoreIntegration {
    ...
    private static void registerContent(IMissionRegistry registry) {
        ...
        registerMission(registry, "build_basic_altar", "Build Basic Altar", "Craft and place the first shared ritual center.",
                "Basic altar online.", MissionObjectiveType.OBTAIN_ITEM, id("basic_altar"), new ItemStack(ModBlocks.BASIC_ALTAR.get()));
        registerMission(registry, "place_rune_circle", "Place Rune Circle", "Lay a ritual circuit block for array guidance.",
                "Rune circuit placed.", MissionObjectiveType.OBTAIN_ITEM, id("rune_circle"), new ItemStack(ModBlocks.RUNE_CIRCLE.get()));
        registerMission(registry, "complete_aether_calibration", "Complete Aether Calibration",
                ...
                new ItemStack(ModItems.AETHER_CHALK.get()));
        registerMission(registry, "complete_relic_stabilization", "Complete Relic Stabilization",
                ...
                new ItemStack(ModItems.STABILITY_SEAL.get()));
        ...
        registerMission(registry, "awaken_spell_core", "Awaken Spell Core",
                ...
                new ItemStack(ModItems.AWAKENED_SPELL_CORE.get()));
        registerMission(registry, "reveal_rift_crack", "Reveal Rift Crack",
                ...
                new ItemStack(ModItems.REFINED_AETHER_SAMPLE.get()));
        registerMission(registry, "prevent_ritual_backlash", "Prevent Ritual Backlash",
                ...
                new ItemStack(ModBlocks.STABILITY_PYLON.get()));
    }
    ...
    private static ItemStack rewardStack(String path) {
        return switch (path) {
            case "build_basic_altar" -> new ItemStack(ModItems.AETHER_CHALK.get(), 4);
            case "place_rune_circle" -> new ItemStack(ModItems.RITUAL_FOCUS.get(), 1);
            case "complete_aether_calibration" -> new ItemStack(ModItems.REFINED_AETHER_SAMPLE.get(), 2);
            case "complete_relic_stabilization" -> new ItemStack(ModItems.REFINED_AETHER_SAMPLE.get(), 2);
            case "cleanse_cursed_relic" -> new ItemStack(ModItems.CURSE_ASH.get(), 1);
            case "awaken_spell_core" -> new ItemStack(ModItems.AETHER_CHALK.get(), 4);
            case "reveal_rift_crack" -> new ItemStack(ModItems.STABILITY_SEAL.get(), 1);
            default -> new ItemStack(ModItems.STABILITY_SEAL.get(), 1);
        };
    }
