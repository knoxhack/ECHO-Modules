# ECHO: Convoy Protocol Artifact Notes

This file documents the release outputs expected for `echoconvoyprotocol` version `1.0.0`.
...
| `echoconvoyprotocol-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
