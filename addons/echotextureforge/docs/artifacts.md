# ECHO: TextureForge Artifact Notes

This file documents the release outputs expected for `echotextureforge` version `1.0.0`.
...
| `echotextureforge-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
