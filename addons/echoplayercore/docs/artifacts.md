# ECHO: PlayerCore Artifact Notes

This file documents the release outputs expected for `echoplayercore` version `1.0.0`.
...
| `echoplayercore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
