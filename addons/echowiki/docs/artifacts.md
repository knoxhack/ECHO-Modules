# ECHO: Wiki Artifact Notes

This file documents the release outputs expected for `echowiki` version `1.0.0`.
...
| `echowiki-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
