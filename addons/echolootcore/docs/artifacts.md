# ECHO: LootCore Artifact Notes

This file documents the release outputs expected for `echolootcore` version `1.0.0`.
...
| `echolootcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
