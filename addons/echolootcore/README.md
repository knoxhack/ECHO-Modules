...
Provides `loot.anti_duplication`, `loot.mission_reward_pools`, `loot.pools` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echolootcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `loot_core` |
...
Provides: `loot.anti_duplication`, `loot.mission_reward_pools`, `loot.pools`
...
| File | Requirement |
| --- | --- |
| `echolootcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echolootcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echolootcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echolootcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echolootcore
```
