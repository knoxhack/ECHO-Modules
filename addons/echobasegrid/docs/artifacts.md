# ECHO: Base Grid Artifact Notes

This file documents the release outputs expected for `echobasegrid` version `1.0.0`.
...
| `echobasegrid-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
