...
Provides `cinematic.pacing`, `cinematic.screenshot_mode`, `cinematic.sequences`, `cinematic.triggers` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocinematiccore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `cinematic_core` |
...
Provides: `cinematic.pacing`, `cinematic.screenshot_mode`, `cinematic.sequences`, `cinematic.triggers`

Consumes: `assets.registry`, `echo.core`, `platform.contracts`, `schema.registry`, `validation.pack`
...
| File | Requirement |
| --- | --- |
| `echocinematiccore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echocinematiccore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echocinematiccore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echocinematiccore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echocinematiccore
```
