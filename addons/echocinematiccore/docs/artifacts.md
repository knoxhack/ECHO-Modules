# ECHO: CinematicCore Artifact Notes

This file documents the release outputs expected for `echocinematiccore` version `1.0.0`.
...
| `echocinematiccore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
