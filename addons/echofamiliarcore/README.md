...
Provides: `familiar.bonds`, `familiar.commands`, `familiar.companions`, `familiar.registry`, `familiar.upgrades`
...
| File | Requirement |
| --- | --- |
| `echofamiliarcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echofamiliarcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echofamiliarcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echofamiliarcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echofamiliarcore
```
