# ECHO: FamiliarCore Artifact Notes

This file documents the release outputs expected for `echofamiliarcore` version `1.0.0`.
...
| `echofamiliarcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
