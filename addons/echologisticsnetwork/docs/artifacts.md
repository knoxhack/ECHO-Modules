# ECHO: Logistics Network Artifact Notes

This file documents the release outputs expected for `echologisticsnetwork` version `1.0.0`.
...
| `echologisticsnetwork-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
