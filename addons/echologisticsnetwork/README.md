...
Provides `logistics.couriers`, `logistics.dashboards`, `logistics.depots`, `logistics.endpoints`, `logistics.requests` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echologisticsnetwork` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `tech` |
...
Optional modules: `echoarmory`, `echoconvoyprotocol`, `echoholomap`, `echopowergrid`, `echoterminal`, `echothemecore`

Provides: `logistics.couriers`, `logistics.dashboards`, `logistics.depots`, `logistics.endpoints`, `logistics.requests`
...
| File | Requirement |
| --- | --- |
| `echologisticsnetwork-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echologisticsnetwork-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echologisticsnetwork-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echologisticsnetwork-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echologisticsnetwork
```
