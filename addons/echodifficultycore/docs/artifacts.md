# ECHO: DifficultyCore Artifact Notes

This file documents the release outputs expected for `echodifficultycore` version `1.0.0`.
...
| `echodifficultycore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
