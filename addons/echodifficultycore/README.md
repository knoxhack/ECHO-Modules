...
Provides `difficulty.adaptive`, `difficulty.profiles`, `difficulty.telemetry` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echodifficultycore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `difficulty_core` |
| Side | `common` |
| Trust | `official` |
...
Provides: `difficulty.adaptive`, `difficulty.profiles`, `difficulty.telemetry`

Consumes: `content.gates`, `content.references`, `echo.core`, `pack.profile`, `platform.contracts`, `schema.registry`, `validation.pack`
...
| File | Requirement |
| --- | --- |
| `echodifficultycore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echodifficultycore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echodifficultycore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echodifficultycore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echodifficultycore
```
