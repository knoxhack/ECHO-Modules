...
Provides `render.animation_profiles`, `render.creator_exports`, `render.diagnostics`, `render.particle_profiles`, `render.preview`, `render.profiles`, `render.screen_chrome`, `render.validation` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echorendercore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `render_core` |
...
Optional modules: `echoruntimeguard`, `echoscreencore`, `echothemecore`

Provides: `render.animation_profiles`, `render.creator_exports`, `render.diagnostics`, `render.particle_profiles`, `render.preview`, `render.profiles`, `render.screen_chrome`, `render.validation`
...
| File | Requirement |
| --- | --- |
| `echorendercore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echorendercore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echorendercore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echorendercore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echorendercore
```
