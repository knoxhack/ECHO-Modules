# ECHO: RenderCore Artifact Notes

This file documents the release outputs expected for `echorendercore` version `1.0.0`.
...
| `echorendercore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
