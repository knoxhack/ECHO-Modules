# ECHO: SpawnCore Artifact Notes

This file documents the release outputs expected for `echospawncore` version `1.0.0`.
...
| `echospawncore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
