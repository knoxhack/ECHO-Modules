...
Provides `community.discord_relay`, `community.server_events`, `community.server_status`, `launcher.server_status_bridge` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocommunitybridge` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `service` |
| Role | `utility` |
...
```sh
node scripts/generate-module-release.mjs --module echocommunitybridge
```
