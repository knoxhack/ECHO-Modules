# ECHO: ContentCore Artifact Notes

This file documents the release outputs expected for `echocontentcore` version `1.0.0`.
...
| `echocontentcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
