# ECHO: Lens Artifact Notes

This file documents the release outputs expected for `echolens` version `1.0.0`.

## Artifact Matrix

| File | Requirement |
| --- | --- |
| `echolens-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echolens-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echolens-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echolens-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
| `echolens-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
