...
Optional modules: `echodatacore`, `echoholomap`, `echoindex`, `echomissioncore`, `echothemecore`

Provides: `lens.scanners`
...
```sh
node scripts/generate-module-release.mjs --module echolens
```
