...
public final class EchoSettlementCoreNativeModule implements EchoNativeSurfaceModuleEntrypoint {
    ...
    public Map<String, Object> describeNativeSurfaces(Map<String, String> context) {
        ...
        result.put("summary", "Bases, shelters, NPC jobs, storage needs, defense score, comfort, and logistics request contracts.");
    ...
    public static void main(String[] args) {
        ...
        require(Boolean.FALSE.equals(activation.get("registryMutated")),
                "echosettlementcore native adapter must stay contract-first");
