# ECHO: ReportCore Artifact Notes

This file documents the release outputs expected for `echoreportcore` version `1.0.0`.
...
| `echoreportcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
