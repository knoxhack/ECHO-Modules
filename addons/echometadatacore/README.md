...
Provides `metadata.manifest`, `metadata.ai`, `metadata.migration` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echometadatacore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `metadata_core` |
...
Required modules: `echoadaptercore`, `echocore`, `echoplatformcore`, `echoschemacore`, `echovalidationcore`, `echopackcore`

Optional modules: None declared.

Provides: `metadata.manifest`, `metadata.ai`, `metadata.migration`

Consumes: `echo.core`, `platform.contracts`, `schema.registry`, `validation.pack`, `pack.profile`
...
| File | Requirement |
| --- | --- |
| `echometadatacore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echometadatacore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echometadatacore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echometadatacore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echometadatacore
```
