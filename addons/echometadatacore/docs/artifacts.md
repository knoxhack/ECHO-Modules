# ECHO: MetadataCore Artifact Notes

This file documents the release outputs expected for `echometadatacore` version `1.0.0`.
...
| `echometadatacore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
