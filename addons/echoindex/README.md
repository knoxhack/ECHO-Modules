...
Provides `index.recipes`, `index.inventory_overlay`, `echoindex:inventory_overlay` for the ECHO module graph.
...
Optional modules: `echoholomap`, `echolens`, `echomissioncore`, `echoterminal`, `echothemecore`, `echowiki`
...
```sh
node scripts/generate-module-release.mjs --module echoindex
```
