# ECHO: CombatCore Artifact Notes

This file documents the release outputs expected for `echocombatcore` version `1.0.0`.
...
| `echocombatcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
