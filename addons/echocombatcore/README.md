...
Provides `combat.armor_profiles`, `combat.damage`, `combat.telemetry`, `combat.weapon_traits` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocombatcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `combat_core` |
...
Provides: `combat.armor_profiles`, `combat.damage`, `combat.telemetry`, `combat.weapon_traits`
...
| File | Requirement |
| --- | --- |
| `echocombatcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echocombatcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echocombatcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echocombatcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echocombatcore
```
