...
Provides `camera.profiles`, `camera.safety`, `camera.screenshot_mode`, `camera.shake` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocameracore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `camera_core` |
...
Provides: `camera.profiles`, `camera.safety`, `camera.screenshot_mode`, `camera.shake`
...
| File | Requirement |
| --- | --- |
| `echocameracore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echocameracore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echocameracore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echocameracore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echocameracore
```
