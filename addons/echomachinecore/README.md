...
Provides `machine.automation`, `machine.diagnostics`, `machine.profiles`, `machine.recipes` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echomachinecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `machine_core` |
...
Required modules: `echoadaptercore`, `echoassetcore`, `echocontentcore`, `echocore`, `echoplatformcore`, `echorecipecore`, `echoschemacore`, `echovalidationcore`

Optional modules: None declared.

Provides: `machine.automation`, `machine.diagnostics`, `machine.profiles`, `machine.recipes`
...
| File | Requirement |
| --- | --- |
| `echomachinecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echomachinecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echomachinecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echomachinecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echomachinecore
```
