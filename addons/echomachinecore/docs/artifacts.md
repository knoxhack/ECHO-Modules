# ECHO: MachineCore Artifact Notes

This file documents the release outputs expected for `echomachinecore` version `1.0.0`.
...
| `echomachinecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
