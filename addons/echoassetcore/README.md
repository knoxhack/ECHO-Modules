...
Provides: `assets.registry`, `assets.validation`, `textureforge.prompts`, `textureforge.reports`
...
| File | Requirement |
| --- | --- |
| `echoassetcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoassetcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoassetcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoassetcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoassetcore
```
