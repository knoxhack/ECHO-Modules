# ECHO: AssetCore Artifact Notes

This file documents the release outputs expected for `echoassetcore` version `1.0.0`.
...
| `echoassetcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
