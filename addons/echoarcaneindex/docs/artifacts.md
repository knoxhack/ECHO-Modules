# ECHO: Arcane Index Artifact Notes

This file documents the release outputs expected for `echoarcaneindex` version `1.0.0`.
...
| `echoarcaneindex-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
