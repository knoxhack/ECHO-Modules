...
Reusable authoring blueprints for common content types and Studio template generation.
...
- MVP contracts: `blueprint_schema`, `studio_template_generation`, `content_type_blueprints`
