...
Provides `runtime.budgets`, `runtime.diagnostics`, `runtime.health`, `runtime.network_budget`, `runtime.particle_budget`, `runtime.performance_profiles`, `runtime.smart_ticks` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoruntimeguard` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `foundation` |
...
Optional modules: `echodatacore`, `echoholomap`, `echolens`, `echomultiblockcore`, `echoterminal`, `echothemecore`

Provides: `runtime.budgets`, `runtime.diagnostics`, `runtime.health`, `runtime.network_budget`, `runtime.particle_budget`, `runtime.performance_profiles`, `runtime.smart_ticks`
...
| File | Requirement |
| --- | --- |
| `echoruntimeguard-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoruntimeguard-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoruntimeguard-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoruntimeguard-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoruntimeguard
```
