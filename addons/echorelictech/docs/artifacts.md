# ECHO: RelicTech Artifact Notes

This file documents the release outputs expected for `echorelictech` version `1.0.0`.
...
| `echorelictech-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
