...
Provides `relictech.analysis`, `relictech.containment`, `relictech.instability`, `relictech.relics`, `relictech.research`, `relictech.vaults` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echorelictech` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echoarcanacore`, `echodatacore`, `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echonexusprotocol`, `echopowergrid`, `echosoundcore`, `echoterminal`, `echoworldcore`

Provides: `relictech.analysis`, `relictech.containment`, `relictech.instability`, `relictech.relics`, `relictech.research`, `relictech.vaults`
...
| File | Requirement |
| --- | --- |
| `echorelictech-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echorelictech-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echorelictech-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echorelictech-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echorelictech
```
