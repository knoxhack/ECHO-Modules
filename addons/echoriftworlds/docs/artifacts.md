# ECHO: RiftWorlds Artifact Notes

This file documents the release outputs expected for `echoriftworlds` version `1.0.0`.
...
| `echoriftworlds-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
