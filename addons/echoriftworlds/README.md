...
Provides `riftworlds.arcana_provider`, `riftworlds.dimensional_hazards`, `riftworlds.pocket_rifts`, `riftworlds.rift_cracks`, `riftworlds.ruins` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoriftworlds` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echocursecore`, `echoholomap`, `echolens`, `echoritualcore`

Provides: `riftworlds.arcana_provider`, `riftworlds.dimensional_hazards`, `riftworlds.pocket_rifts`, `riftworlds.rift_cracks`, `riftworlds.ruins`
...
| File | Requirement |
| --- | --- |
| `echoriftworlds-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoriftworlds-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoriftworlds-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoriftworlds-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoriftworlds
```
