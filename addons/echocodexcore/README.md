...
Provides `codex.archive`, `codex.discovery`, `codex.search` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocodexcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `codex_core` |
...
Provides: `codex.archive`, `codex.discovery`, `codex.search`
...
| File | Requirement |
| --- | --- |
| `echocodexcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echocodexcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echocodexcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echocodexcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echocodexcore
```
