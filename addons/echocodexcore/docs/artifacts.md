# ECHO: CodexCore Artifact Notes

This file documents the release outputs expected for `echocodexcore` version `1.0.0`.
...
| `echocodexcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
