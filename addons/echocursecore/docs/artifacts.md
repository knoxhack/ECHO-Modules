# ECHO: CurseCore Artifact Notes

This file documents the release outputs expected for `echocursecore` version `1.0.0`.
...
| `echocursecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
