...
Provides `atmosphere.fog`, `atmosphere.hooks`, `atmosphere.profiles`, `atmosphere.sky` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoatmospherecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `atmosphere_core` |
| Side | `common` |
| Trust | `official` |
...
Provides: `atmosphere.fog`, `atmosphere.hooks`, `atmosphere.profiles`, `atmosphere.sky`
...
| File | Requirement |
| --- | --- |
| `echoatmospherecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoatmospherecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoatmospherecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoatmospherecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoatmospherecore
```
