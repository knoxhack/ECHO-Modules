...
Provides `progression.feature_unlocks`, `progression.gates`, `progression.objectives`, `progression.recipe_unlocks`, `progression.server_objectives`, `progression.team_objectives`, `progression.ui_surface_unlocks`, `progression.unlock_graph`, `progression.world_event_unlocks` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoprogressioncore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `progression_core` |
| Side | `common` |
| Trust | `official` |
...
Required modules: `echoadaptercore`, `echocontentcore`, `echocore`, `echoplatformcore`, `echorecipecore`, `echoschemacore`, `echovalidationcore`

Optional modules: None declared.

Provides: `progression.feature_unlocks`, `progression.gates`, `progression.objectives`, `progression.recipe_unlocks`, `progression.server_objectives`, `progression.team_objectives`, `progression.ui_surface_unlocks`, `progression.unlock_graph`, `progression.world_event_unlocks`
...
| File | Requirement |
| --- | --- |
| `echoprogressioncore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoprogressioncore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoprogressioncore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoprogressioncore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoprogressioncore
```
