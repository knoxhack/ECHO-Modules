# ECHO: ProgressionCore Artifact Notes

This file documents the release outputs expected for `echoprogressioncore` version `1.0.0`.
...
| `echoprogressioncore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
