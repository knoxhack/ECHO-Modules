...
Provides `sound.adaptive_music`, `sound.ambience`, `sound.audio_profiles`, `sound.diagnostics`, `sound.network_actions`, `sound.service`, `sound.stingers`, `sound.ui_cues` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echosoundcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `sound_core` |
...
Optional modules: `echoarmory`, `echoblackboxprotocol`, `echoconvoyprotocol`, `echoholomap`, `echoindustrialnexus`, `echolens`, `echologisticsnetwork`, `echomissioncore`, `echonexusprotocol`, `echopowergrid`, `echorendercore`, `echoruntimeguard`, `signalos`, `echostationfall`, `echoterminal`, `echothemecore`, `echoweathercore`, `echoworldcore`

Provides: `sound.adaptive_music`, `sound.ambience`, `sound.audio_profiles`, `sound.diagnostics`, `sound.network_actions`, `sound.service`, `sound.stingers`, `sound.ui_cues`
...
| File | Requirement |
| --- | --- |
| `echosoundcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echosoundcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echosoundcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echosoundcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echosoundcore
```
