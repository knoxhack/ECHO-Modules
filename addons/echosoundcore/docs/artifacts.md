# ECHO: SoundCore Artifact Notes

This file documents the release outputs expected for `echosoundcore` version `1.0.0`.
...
| `echosoundcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
