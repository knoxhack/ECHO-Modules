# SignalOS Example Addon Artifact Notes

This file documents the release outputs expected for `signalosexample` version `1.0.0`.
...
| `signalosexample-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
