# ECHO: BridgeCore Artifact Notes

This file documents the release outputs expected for `echobridgecore` version `1.0.0`.
...
| `echobridgecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
