...
Provides `orbital.content`, `orbital.factions`, `orbital.routes`, `orbital.survival`, `orbital.surveys`, `orbital.terminal_records` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoorbitalremnants` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echoholomap`, `echoindex`, `echomissioncore`, `echorendercore`, `echosoundcore`, `echoterminal`

Provides: `orbital.content`, `orbital.factions`, `orbital.routes`, `orbital.survival`, `orbital.surveys`, `orbital.terminal_records`
...
| File | Requirement |
| --- | --- |
| `echoorbitalremnants-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoorbitalremnants-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoorbitalremnants-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoorbitalremnants-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoorbitalremnants
```
