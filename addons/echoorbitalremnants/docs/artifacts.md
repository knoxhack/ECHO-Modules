# ECHO: Orbital Remnants Artifact Notes

This file documents the release outputs expected for `echoorbitalremnants` version `1.0.0`.
...
| `echoorbitalremnants-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
