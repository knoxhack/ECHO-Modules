...
Provides `economy.barter`, `economy.currencies`, `economy.faction_shops`, `economy.trade_validation` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoeconomycore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `economy_core` |
...
Provides: `economy.barter`, `economy.currencies`, `economy.faction_shops`, `economy.trade_validation`
...
| File | Requirement |
| --- | --- |
| `echoeconomycore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoeconomycore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoeconomycore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoeconomycore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoeconomycore
```
