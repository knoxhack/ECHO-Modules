# ECHO: EconomyCore Artifact Notes

This file documents the release outputs expected for `echoeconomycore` version `1.0.0`.
...
| `echoeconomycore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
