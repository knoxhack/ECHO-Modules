# ECHO: CreatorCore Artifact Notes

This file documents the release outputs expected for `echocreatorcore` version `1.0.0`.
...
| `echocreatorcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
