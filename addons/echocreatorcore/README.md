...
Provides `creator.adapters`, `creator.codex_studio`, `creator.dashboard`, `creator.drafts`, `creator.validation` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echocreatorcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `tooling` |
| Role | `developer_tool` |
...
Optional modules: `echodatacore`, `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echonpcore`, `echoscreencore`, `echoscriptcore`, `echosoundcore`, `echoterminal`, `echotextureforge`, `echothemecore`, `echotutorialcore`, `echoweathercore`, `echowiki`, `echoworldcore`

Provides: `creator.adapters`, `creator.codex_studio`, `creator.dashboard`, `creator.drafts`, `creator.validation`
...
| File | Requirement |
| --- | --- |
| `echocreatorcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echocreatorcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echocreatorcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echocreatorcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echocreatorcore
```
