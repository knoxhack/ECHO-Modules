...
Optional modules: `echodatacore`, `echoindex`, `echoterminal`, `echotutorialcore`
...
```sh
node scripts/generate-module-release.mjs --module echomissioncore
```
