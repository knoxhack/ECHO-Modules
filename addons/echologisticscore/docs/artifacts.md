# ECHO: LogisticsCore Artifact Notes

This file documents the release outputs expected for `echologisticscore` version `1.0.0`.
...
| `echologisticscore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
