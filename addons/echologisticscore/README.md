...
Provides `logistics.convoy_bindings`, `logistics.deliveries`, `logistics.routing`, `logistics.storage` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echologisticscore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `logistics_core` |
...
Required modules: `echoadaptercore`, `echoassetcore`, `echocontentcore`, `echocore`, `echoplatformcore`, `echoschemacore`, `echovalidationcore`

Optional modules: None declared.

Provides: `logistics.convoy_bindings`, `logistics.deliveries`, `logistics.routing`, `logistics.storage`

Consumes: `assets.registry`, `content.references`, `echo.core`, `platform.contracts`, `schema.registry`, `validation.pack`
...
| File | Requirement |
| --- | --- |
| `echologisticscore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echologisticscore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echologisticscore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echologisticscore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echologisticscore
```
