# ECHO: LoreCore Artifact Notes

This file documents the release outputs expected for `echolorecore` version `1.0.0`.
...
| `echolorecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
