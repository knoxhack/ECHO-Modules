...
Provides `lore.audio_logs`, `lore.blackbox_entries`, `lore.entries`, `lore.environmental_storytelling` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echolorecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `lore_core` |
...
Provides: `lore.audio_logs`, `lore.blackbox_entries`, `lore.entries`, `lore.environmental_storytelling`
...
| File | Requirement |
| --- | --- |
| `echolorecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echolorecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echolorecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echolorecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echolorecore
```
