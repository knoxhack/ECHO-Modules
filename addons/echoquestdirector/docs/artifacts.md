# ECHO: QuestDirector Artifact Notes

This file documents the release outputs expected for `echoquestdirector` version `1.0.0`.
...
| `echoquestdirector-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
