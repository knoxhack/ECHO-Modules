...
Provides `questdirector.campaign_pressure`, `questdirector.mission_selection`, `questdirector.recommendations`, `questdirector.reminders`, `questdirector.route_pacing`, `questdirector.signals`, `questdirector.world_event_pacing` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoquestdirector` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `quest_director` |
...
Required modules: `echoadaptercore`, `echocontentcore`, `echocore`, `echopackcore`, `echoplatformcore`, `echoschemacore`, `echovalidationcore`

Optional modules: None declared.

Provides: `questdirector.campaign_pressure`, `questdirector.mission_selection`, `questdirector.recommendations`, `questdirector.reminders`, `questdirector.route_pacing`, `questdirector.signals`, `questdirector.world_event_pacing`

Consumes: `content.references`, `echo.core`, `pack.profile`, `platform.contracts`, `schema.registry`, `validation.pack`
...
| File | Requirement |
| --- | --- |
| `echoquestdirector-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoquestdirector-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoquestdirector-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoquestdirector-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoquestdirector
```
