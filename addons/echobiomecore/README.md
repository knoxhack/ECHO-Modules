...
Provides `biome.ambience`, `biome.hazards`, `biome.holomap_layers`, `biome.profiles` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echobiomecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `biome_core` |
...
Provides: `biome.ambience`, `biome.hazards`, `biome.holomap_layers`, `biome.profiles`
...
| File | Requirement |
| --- | --- |
| `echobiomecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echobiomecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echobiomecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echobiomecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echobiomecore
```
