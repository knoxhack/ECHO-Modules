# ECHO: BiomeCore Artifact Notes

This file documents the release outputs expected for `echobiomecore` version `1.0.0`.
...
| `echobiomecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
