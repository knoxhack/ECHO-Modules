...
Provides `input.contexts`, `input.controller_ready`, `input.keybind_registry`, `input.radial_menus` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoinputcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `input_core` |
...
Provides: `input.contexts`, `input.controller_ready`, `input.keybind_registry`, `input.radial_menus`
...
| File | Requirement |
| --- | --- |
| `echoinputcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoinputcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoinputcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoinputcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoinputcore
```
