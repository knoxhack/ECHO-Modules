# ECHO: InputCore Artifact Notes

This file documents the release outputs expected for `echoinputcore` version `1.0.0`.
...
| `echoinputcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
