# ECHO: Presence Link Artifact Notes

This file documents the release outputs expected for `echopresencelink` version `1.0.0`.
...
| `echopresencelink-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
