# ECHO: Recovery Artifact Notes

This file documents the release outputs expected for `echorecovery` version `1.3.0`.
...
| `echorecovery-1.3.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
