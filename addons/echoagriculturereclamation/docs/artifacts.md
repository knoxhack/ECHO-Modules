# ECHO: Agriculture Reclamation Artifact Notes

This file documents the release outputs expected for `echoagriculturereclamation` version `1.0.0`.
...
| `echoagriculturereclamation-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
