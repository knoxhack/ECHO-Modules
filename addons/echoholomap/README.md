...
Optional modules: `echolens`, `echomissioncore`, `echoterminal`, `echothemecore`, `echoworldcore`

Provides: `holomap.layers`
...
```sh
node scripts/generate-module-release.mjs --module echoholomap
```
