...
/**
 * Bridges {echostructurecore} spine events into the AdapterCore truth layer.
 */
public final class EchoStructurecoreTruthBridge {
    private static final String SOURCE_MODULE = "echostructurecore";
    private static boolean registered;

    private EchoStructurecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echostructurecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echostructurecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
