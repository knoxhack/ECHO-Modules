...
/**
 * Bridges {echobridgecore} spine events into the AdapterCore truth layer.
 */
public final class EchoBridgecoreTruthBridge {
    private static final String SOURCE_MODULE = "echobridgecore";
    private static boolean registered;

    private EchoBridgecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echobridgecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echobridgecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
