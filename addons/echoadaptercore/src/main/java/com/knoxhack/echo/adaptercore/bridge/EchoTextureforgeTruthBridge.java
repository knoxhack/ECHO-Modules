...
/**
 * Bridges {echotextureforge} spine events into the AdapterCore truth layer.
 */
public final class EchoTextureforgeTruthBridge {
    private static final String SOURCE_MODULE = "echotextureforge";
    private static boolean registered;

    private EchoTextureforgeTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echotextureforge".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echotextureforge:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
