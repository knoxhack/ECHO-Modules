...
/**
 * Bridges {echoeventcore} spine events into the AdapterCore truth layer.
 */
public final class EchoEventcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoeventcore";
    private static boolean registered;

    private EchoEventcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoeventcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoeventcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
