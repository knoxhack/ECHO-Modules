...
/**
 * Bridges {echocursecore} spine events into the AdapterCore truth layer.
 */
public final class EchoCursecoreTruthBridge {
    private static final String SOURCE_MODULE = "echocursecore";
    private static boolean registered;

    private EchoCursecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocursecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocursecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
