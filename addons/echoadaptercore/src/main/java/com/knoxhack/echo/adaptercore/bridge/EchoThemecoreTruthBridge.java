...
/**
 * Bridges {echothemecore} spine events into the AdapterCore truth layer.
 */
public final class EchoThemecoreTruthBridge {
    private static final String SOURCE_MODULE = "echothemecore";
    private static boolean registered;

    private EchoThemecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echothemecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echothemecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
