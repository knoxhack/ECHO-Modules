...
/**
 * Bridges {echoblockworks} spine events into the AdapterCore truth layer.
 */
public final class EchoBlockworksTruthBridge {
    private static final String SOURCE_MODULE = "echoblockworks";
    private static boolean registered;

    private EchoBlockworksTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoblockworks".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoblockworks:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
