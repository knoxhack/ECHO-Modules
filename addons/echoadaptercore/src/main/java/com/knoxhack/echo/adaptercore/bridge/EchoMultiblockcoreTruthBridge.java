...
/**
 * Bridges {echomultiblockcore} spine events into the AdapterCore truth layer.
 */
public final class EchoMultiblockcoreTruthBridge {
    private static final String SOURCE_MODULE = "echomultiblockcore";
    private static boolean registered;

    private EchoMultiblockcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echomultiblockcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echomultiblockcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
