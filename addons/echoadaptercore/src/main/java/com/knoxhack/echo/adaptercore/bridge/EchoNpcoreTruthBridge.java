...
/**
 * Bridges {echonpcore} spine events into the AdapterCore truth layer.
 */
public final class EchoNpcoreTruthBridge {
    private static final String SOURCE_MODULE = "echonpcore";
    private static boolean registered;

    private EchoNpcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echonpcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echonpcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
