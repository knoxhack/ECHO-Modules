...
/**
 * Bridges {echoagentcore} spine events into the AdapterCore truth layer.
 */
public final class EchoAgentcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoagentcore";
    private static boolean registered;

    private EchoAgentcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoagentcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoagentcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
