...
/**
 * Bridges {echoplayercore} spine events into the AdapterCore truth layer.
 */
public final class EchoPlayercoreTruthBridge {
    private static final String SOURCE_MODULE = "echoplayercore";
    private static boolean registered;

    private EchoPlayercoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoplayercore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoplayercore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
