...
/**
 * Bridges {echosocialcore} spine events into the AdapterCore truth layer.
 */
public final class EchoSocialcoreTruthBridge {
    private static final String SOURCE_MODULE = "echosocialcore";
    private static boolean registered;

    private EchoSocialcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echosocialcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echosocialcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
