...
/**
 * Bridges {echocameracore} spine events into the AdapterCore truth layer.
 */
public final class EchoCameracoreTruthBridge {
    private static final String SOURCE_MODULE = "echocameracore";
    private static boolean registered;

    private EchoCameracoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocameracore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocameracore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
