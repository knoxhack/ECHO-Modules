...
/**
 * Bridges {@code echoterminal} UI action events into the AdapterCore truth layer.
 */
public final class EchoTerminalTruthBridge {
    private static final String SOURCE_MODULE = "echoterminal";
    private static boolean registered;

    private EchoTerminalTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoterminal".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "terminal:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
