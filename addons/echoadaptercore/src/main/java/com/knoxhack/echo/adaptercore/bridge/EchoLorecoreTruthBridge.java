...
/**
 * Bridges {echolorecore} spine events into the AdapterCore truth layer.
 */
public final class EchoLorecoreTruthBridge {
    private static final String SOURCE_MODULE = "echolorecore";
    private static boolean registered;

    private EchoLorecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echolorecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echolorecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
