...
/**
 * Bridges {echopowercore} spine events into the AdapterCore truth layer.
 */
public final class EchoPowercoreTruthBridge {
    private static final String SOURCE_MODULE = "echopowercore";
    private static boolean registered;

    private EchoPowercoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echopowercore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echopowercore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
