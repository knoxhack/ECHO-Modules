...
/**
 * Bridges {echosoundcore} spine events into the AdapterCore truth layer.
 */
public final class EchoSoundcoreTruthBridge {
    private static final String SOURCE_MODULE = "echosoundcore";
    private static boolean registered;

    private EchoSoundcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echosoundcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echosoundcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
