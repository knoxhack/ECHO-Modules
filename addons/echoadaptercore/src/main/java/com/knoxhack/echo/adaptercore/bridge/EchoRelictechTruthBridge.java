...
/**
 * Bridges {echorelictech} spine events into the AdapterCore truth layer.
 */
public final class EchoRelictechTruthBridge {
    private static final String SOURCE_MODULE = "echorelictech";
    private static boolean registered;

    private EchoRelictechTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echorelictech".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echorelictech:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
