...
/**
 * Bridges {echocinematiccore} spine events into the AdapterCore truth layer.
 */
public final class EchoCinematiccoreTruthBridge {
    private static final String SOURCE_MODULE = "echocinematiccore";
    private static boolean registered;

    private EchoCinematiccoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocinematiccore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocinematiccore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
