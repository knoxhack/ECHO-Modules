...
/**
 * Bridges {echovalidationcore} spine events into the AdapterCore truth layer.
 */
public final class EchoValidationcoreTruthBridge {
    private static final String SOURCE_MODULE = "echovalidationcore";
    private static boolean registered;

    private EchoValidationcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echovalidationcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echovalidationcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
