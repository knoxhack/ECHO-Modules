...
/**
 * Bridges {echoarcanacore} spine events into the AdapterCore truth layer.
 */
public final class EchoArcanacoreTruthBridge {
    private static final String SOURCE_MODULE = "echoarcanacore";
    private static boolean registered;

    private EchoArcanacoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoarcanacore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoarcanacore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
