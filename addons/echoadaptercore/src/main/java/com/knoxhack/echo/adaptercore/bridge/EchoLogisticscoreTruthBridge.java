...
/**
 * Bridges {echologisticscore} spine events into the AdapterCore truth layer.
 */
public final class EchoLogisticscoreTruthBridge {
    private static final String SOURCE_MODULE = "echologisticscore";
    private static boolean registered;

    private EchoLogisticscoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echologisticscore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echologisticscore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
