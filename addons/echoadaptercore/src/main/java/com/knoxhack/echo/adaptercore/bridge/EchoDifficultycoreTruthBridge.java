...
/**
 * Bridges {echodifficultycore} spine events into the AdapterCore truth layer.
 */
public final class EchoDifficultycoreTruthBridge {
    private static final String SOURCE_MODULE = "echodifficultycore";
    private static boolean registered;

    private EchoDifficultycoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echodifficultycore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echodifficultycore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
