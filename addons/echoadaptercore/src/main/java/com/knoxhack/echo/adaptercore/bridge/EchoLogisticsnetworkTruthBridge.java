...
/**
 * Bridges {echologisticsnetwork} spine events into the AdapterCore truth layer.
 */
public final class EchoLogisticsnetworkTruthBridge {
    private static final String SOURCE_MODULE = "echologisticsnetwork";
    private static boolean registered;

    private EchoLogisticsnetworkTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echologisticsnetwork".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echologisticsnetwork:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
