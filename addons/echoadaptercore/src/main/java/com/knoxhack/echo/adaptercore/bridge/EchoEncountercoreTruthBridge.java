...
/**
 * Bridges {echoencountercore} spine events into the AdapterCore truth layer.
 */
public final class EchoEncountercoreTruthBridge {
    private static final String SOURCE_MODULE = "echoencountercore";
    private static boolean registered;

    private EchoEncountercoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoencountercore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoencountercore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
