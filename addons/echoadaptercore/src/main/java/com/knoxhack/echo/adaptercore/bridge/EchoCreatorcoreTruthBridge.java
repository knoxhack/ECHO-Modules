...
/**
 * Bridges {echocreatorcore} spine events into the AdapterCore truth layer.
 */
public final class EchoCreatorcoreTruthBridge {
    private static final String SOURCE_MODULE = "echocreatorcore";
    private static boolean registered;

    private EchoCreatorcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocreatorcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocreatorcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
