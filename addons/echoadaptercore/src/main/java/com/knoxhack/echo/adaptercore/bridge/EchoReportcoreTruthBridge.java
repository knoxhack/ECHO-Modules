...
/**
 * Bridges {echoreportcore} spine events into the AdapterCore truth layer.
 */
public final class EchoReportcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoreportcore";
    private static boolean registered;

    private EchoReportcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoreportcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoreportcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
