...
/**
 * Bridges {echoagriculturereclamation} spine events into the AdapterCore truth layer.
 */
public final class EchoAgriculturereclamationTruthBridge {
    private static final String SOURCE_MODULE = "echoagriculturereclamation";
    private static boolean registered;

    private EchoAgriculturereclamationTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoagriculturereclamation".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoagriculturereclamation:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
