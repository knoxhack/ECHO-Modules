...
/**
 * Bridges {echoindustrialnexus} spine events into the AdapterCore truth layer.
 */
public final class EchoIndustrialnexusTruthBridge {
    private static final String SOURCE_MODULE = "echoindustrialnexus";
    private static boolean registered;

    private EchoIndustrialnexusTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoindustrialnexus".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoindustrialnexus:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
