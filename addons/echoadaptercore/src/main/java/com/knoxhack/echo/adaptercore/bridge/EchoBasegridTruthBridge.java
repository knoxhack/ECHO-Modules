...
/**
 * Bridges {echobasegrid} spine events into the AdapterCore truth layer.
 */
public final class EchoBasegridTruthBridge {
    private static final String SOURCE_MODULE = "echobasegrid";
    private static boolean registered;

    private EchoBasegridTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echobasegrid".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echobasegrid:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
