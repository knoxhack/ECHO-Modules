...
/**
 * Bridges {echoprimecore} spine events into the AdapterCore truth layer.
 */
public final class EchoPrimecoreTruthBridge {
    private static final String SOURCE_MODULE = "echoprimecore";
    private static boolean registered;

    private EchoPrimecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoprimecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoprimecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
