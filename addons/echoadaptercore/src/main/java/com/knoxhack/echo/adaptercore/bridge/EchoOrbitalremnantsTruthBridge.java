...
/**
 * Bridges {echoorbitalremnants} spine events into the AdapterCore truth layer.
 */
public final class EchoOrbitalremnantsTruthBridge {
    private static final String SOURCE_MODULE = "echoorbitalremnants";
    private static boolean registered;

    private EchoOrbitalremnantsTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoorbitalremnants".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoorbitalremnants:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
