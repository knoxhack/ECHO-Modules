...
/**
 * Bridges {echospawncore} spine events into the AdapterCore truth layer.
 */
public final class EchoSpawncoreTruthBridge {
    private static final String SOURCE_MODULE = "echospawncore";
    private static boolean registered;

    private EchoSpawncoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echospawncore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echospawncore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
