...
/**
 * Bridges {echoritualcore} spine events into the AdapterCore truth layer.
 */
public final class EchoRitualcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoritualcore";
    private static boolean registered;

    private EchoRitualcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoritualcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoritualcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
