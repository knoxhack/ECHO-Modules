...
/**
 * Bridges {echoblackboxprotocol} spine events into the AdapterCore truth layer.
 */
public final class EchoBlackboxprotocolTruthBridge {
    private static final String SOURCE_MODULE = "echoblackboxprotocol";
    private static boolean registered;

    private EchoBlackboxprotocolTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoblackboxprotocol".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoblackboxprotocol:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
