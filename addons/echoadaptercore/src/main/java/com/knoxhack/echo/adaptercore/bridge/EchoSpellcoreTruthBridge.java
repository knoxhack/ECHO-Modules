...
/**
 * Bridges {echospellcore} spine events into the AdapterCore truth layer.
 */
public final class EchoSpellcoreTruthBridge {
    private static final String SOURCE_MODULE = "echospellcore";
    private static boolean registered;

    private EchoSpellcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echospellcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echospellcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
