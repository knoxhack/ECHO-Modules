...
/**
 * Bridges {echoatmospherecore} spine events into the AdapterCore truth layer.
 */
public final class EchoAtmospherecoreTruthBridge {
    private static final String SOURCE_MODULE = "echoatmospherecore";
    private static boolean registered;

    private EchoAtmospherecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoatmospherecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoatmospherecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
