...
/**
 * Bridges {echoinputcore} spine events into the AdapterCore truth layer.
 */
public final class EchoInputcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoinputcore";
    private static boolean registered;

    private EchoInputcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoinputcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoinputcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
