...
/**
 * Bridges {echopowergrid} spine events into the AdapterCore truth layer.
 */
public final class EchoPowergridTruthBridge {
    private static final String SOURCE_MODULE = "echopowergrid";
    private static boolean registered;

    private EchoPowergridTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echopowergrid".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echopowergrid:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
