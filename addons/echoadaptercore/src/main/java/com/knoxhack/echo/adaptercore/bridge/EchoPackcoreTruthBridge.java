...
/**
 * Bridges {echopackcore} spine events into the AdapterCore truth layer.
 */
public final class EchoPackcoreTruthBridge {
    private static final String SOURCE_MODULE = "echopackcore";
    private static boolean registered;

    private EchoPackcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echopackcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echopackcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
