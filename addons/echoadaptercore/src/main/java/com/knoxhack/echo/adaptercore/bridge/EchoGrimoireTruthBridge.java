...
/**
 * Bridges {echogrimoire} spine events into the AdapterCore truth layer.
 */
public final class EchoGrimoireTruthBridge {
    private static final String SOURCE_MODULE = "echogrimoire";
    private static boolean registered;

    private EchoGrimoireTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echogrimoire".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echogrimoire:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
