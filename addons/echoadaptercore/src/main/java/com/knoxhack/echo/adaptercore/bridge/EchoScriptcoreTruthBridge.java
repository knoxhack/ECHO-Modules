...
/**
 * Bridges {echoscriptcore} spine events into the AdapterCore truth layer.
 */
public final class EchoScriptcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoscriptcore";
    private static boolean registered;

    private EchoScriptcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoscriptcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoscriptcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
