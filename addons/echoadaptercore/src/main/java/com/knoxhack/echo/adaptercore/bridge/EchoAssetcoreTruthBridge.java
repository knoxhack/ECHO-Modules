...
/**
 * Bridges {echoassetcore} spine events into the AdapterCore truth layer.
 */
public final class EchoAssetcoreTruthBridge {
    private static final String SOURCE_MODULE = "echoassetcore";
    private static boolean registered;

    private EchoAssetcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoassetcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoassetcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
