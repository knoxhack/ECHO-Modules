...
/**
 * Bridges {echorecovery} spine events into the AdapterCore truth layer.
 */
public final class EchoRecoveryTruthBridge {
    private static final String SOURCE_MODULE = "echorecovery";
    private static boolean registered;

    private EchoRecoveryTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echorecovery".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echorecovery:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
