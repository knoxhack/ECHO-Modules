...
/**
 * Bridges {echoaddonapi} spine events into the AdapterCore truth layer.
 */
public final class EchoAddonapiTruthBridge {
    private static final String SOURCE_MODULE = "echoaddonapi";
    private static boolean registered;

    private EchoAddonapiTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoaddonapi".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoaddonapi:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
