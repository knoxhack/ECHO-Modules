...
/**
 * Bridges {echonotificationcore} spine events into the AdapterCore truth layer.
 */
public final class EchoNotificationcoreTruthBridge {
    private static final String SOURCE_MODULE = "echonotificationcore";
    private static boolean registered;

    private EchoNotificationcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echonotificationcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echonotificationcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
