...
/**
 * Bridges {echoriftworlds} spine events into the AdapterCore truth layer.
 */
public final class EchoRiftworldsTruthBridge {
    private static final String SOURCE_MODULE = "echoriftworlds";
    private static boolean registered;

    private EchoRiftworldsTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoriftworlds".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoriftworlds:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
