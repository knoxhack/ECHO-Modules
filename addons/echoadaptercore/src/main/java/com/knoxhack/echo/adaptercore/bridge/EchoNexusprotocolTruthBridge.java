...
/**
 * Bridges {echonexusprotocol} spine events into the AdapterCore truth layer.
 */
public final class EchoNexusprotocolTruthBridge {
    private static final String SOURCE_MODULE = "echonexusprotocol";
    private static boolean registered;

    private EchoNexusprotocolTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echonexusprotocol".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echonexusprotocol:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
