...
/**
 * Bridges {echobiomecore} spine events into the AdapterCore truth layer.
 */
public final class EchoBiomecoreTruthBridge {
    private static final String SOURCE_MODULE = "echobiomecore";
    private static boolean registered;

    private EchoBiomecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echobiomecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echobiomecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
