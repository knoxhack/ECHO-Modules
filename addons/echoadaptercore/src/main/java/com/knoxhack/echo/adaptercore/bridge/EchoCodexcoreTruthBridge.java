...
/**
 * Bridges {echocodexcore} spine events into the AdapterCore truth layer.
 */
public final class EchoCodexcoreTruthBridge {
    private static final String SOURCE_MODULE = "echocodexcore";
    private static boolean registered;

    private EchoCodexcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocodexcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocodexcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
