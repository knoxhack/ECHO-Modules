...
/**
 * Bridges {@code echoruntimeguard} budget/throttle events into the AdapterCore truth layer.
 */
public final class EchoRuntimeGuardTruthBridge {
    private static final String SOURCE_MODULE = "echoruntimeguard";
    private static boolean registered;

    private EchoRuntimeGuardTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoruntimeguard".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "runtimeguard:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
