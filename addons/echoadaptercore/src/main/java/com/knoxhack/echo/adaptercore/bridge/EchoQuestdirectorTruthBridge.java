...
/**
 * Bridges {echoquestdirector} spine events into the AdapterCore truth layer.
 */
public final class EchoQuestdirectorTruthBridge {
    private static final String SOURCE_MODULE = "echoquestdirector";
    private static boolean registered;

    private EchoQuestdirectorTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoquestdirector".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoquestdirector:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
