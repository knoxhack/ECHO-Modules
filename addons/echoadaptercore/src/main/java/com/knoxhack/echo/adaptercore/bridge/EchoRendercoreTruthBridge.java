...
/**
 * Bridges {echorendercore} spine events into the AdapterCore truth layer.
 */
public final class EchoRendercoreTruthBridge {
    private static final String SOURCE_MODULE = "echorendercore";
    private static boolean registered;

    private EchoRendercoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echorendercore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echorendercore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
