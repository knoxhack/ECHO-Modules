...
/**
 * Bridges {echoschemacore} spine events into the AdapterCore truth layer.
 */
public final class EchoSchemacoreTruthBridge {
    private static final String SOURCE_MODULE = "echoschemacore";
    private static boolean registered;

    private EchoSchemacoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoschemacore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoschemacore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
