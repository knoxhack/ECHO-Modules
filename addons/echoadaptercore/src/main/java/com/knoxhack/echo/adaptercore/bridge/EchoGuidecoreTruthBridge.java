...
/**
 * Bridges {echoguidecore} spine events into the AdapterCore truth layer.
 */
public final class EchoGuidecoreTruthBridge {
    private static final String SOURCE_MODULE = "echoguidecore";
    private static boolean registered;

    private EchoGuidecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoguidecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoguidecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
