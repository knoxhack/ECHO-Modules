...
/**
 * Bridges {echohealthcore} spine events into the AdapterCore truth layer.
 */
public final class EchoHealthcoreTruthBridge {
    private static final String SOURCE_MODULE = "echohealthcore";
    private static boolean registered;

    private EchoHealthcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echohealthcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echohealthcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
