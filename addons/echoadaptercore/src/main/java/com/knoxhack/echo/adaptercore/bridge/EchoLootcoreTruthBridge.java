...
/**
 * Bridges {echolootcore} spine events into the AdapterCore truth layer.
 */
public final class EchoLootcoreTruthBridge {
    private static final String SOURCE_MODULE = "echolootcore";
    private static boolean registered;

    private EchoLootcoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echolootcore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echolootcore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
