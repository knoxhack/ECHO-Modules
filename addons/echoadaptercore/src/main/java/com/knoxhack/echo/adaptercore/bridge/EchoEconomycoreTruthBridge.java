...
/**
 * Bridges {echoeconomycore} spine events into the AdapterCore truth layer.
 */
public final class EchoEconomycoreTruthBridge {
    private static final String SOURCE_MODULE = "echoeconomycore";
    private static boolean registered;

    private EchoEconomycoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoeconomycore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoeconomycore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
