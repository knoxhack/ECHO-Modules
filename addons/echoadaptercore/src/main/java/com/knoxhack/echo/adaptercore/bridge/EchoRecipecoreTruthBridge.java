...
/**
 * Bridges {echorecipecore} spine events into the AdapterCore truth layer.
 */
public final class EchoRecipecoreTruthBridge {
    private static final String SOURCE_MODULE = "echorecipecore";
    private static boolean registered;

    private EchoRecipecoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echorecipecore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echorecipecore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
