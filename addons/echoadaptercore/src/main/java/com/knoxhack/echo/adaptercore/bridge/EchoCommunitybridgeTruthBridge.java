...
/**
 * Bridges {echocommunitybridge} spine events into the AdapterCore truth layer.
 */
public final class EchoCommunitybridgeTruthBridge {
    private static final String SOURCE_MODULE = "echocommunitybridge";
    private static boolean registered;

    private EchoCommunitybridgeTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echocommunitybridge".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echocommunitybridge:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
