...
/**
 * Bridges {echoscreencore} spine events into the AdapterCore truth layer.
 */
public final class EchoScreencoreTruthBridge {
    private static final String SOURCE_MODULE = "echoscreencore";
    private static boolean registered;

    private EchoScreencoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoscreencore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoscreencore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
