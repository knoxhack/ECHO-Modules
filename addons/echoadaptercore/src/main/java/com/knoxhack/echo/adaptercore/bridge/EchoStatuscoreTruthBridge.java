...
/**
 * Bridges {echostatuscore} spine events into the AdapterCore truth layer.
 */
public final class EchoStatuscoreTruthBridge {
    private static final String SOURCE_MODULE = "echostatuscore";
    private static boolean registered;

    private EchoStatuscoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echostatuscore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echostatuscore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
