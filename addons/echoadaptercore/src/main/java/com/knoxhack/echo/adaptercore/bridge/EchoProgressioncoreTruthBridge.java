...
/**
 * Bridges {echoprogressioncore} spine events into the AdapterCore truth layer.
 */
public final class EchoProgressioncoreTruthBridge {
    private static final String SOURCE_MODULE = "echoprogressioncore";
    private static boolean registered;

    private EchoProgressioncoreTruthBridge() {
    }
            ...
            busClass.getMethod("register", java.util.function.Consumer.class)
                    .invoke(null, (java.util.function.Consumer<Object>) event -> {
                        ...
                        try {
                            ...
                            if (!"echoprogressioncore".equals(sourceModule)) {
                                return;
                            }
                            ...
                            EchoAdapterCoreSpinePublisher.instance().publish(
                                    ...
                                    "echoprogressioncore:" + canonicalEvent + ":" + (playerId.isBlank() ? "world" : playerId) + ":" + System.currentTimeMillis());
