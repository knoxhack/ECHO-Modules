...
public final class EchoMaterialCoreNativeModule implements EchoNativeSurfaceModuleEntrypoint {
    public static final String MODULE_ID = "echomaterialcore";
    ...
    public Map<String, Object> describeNativeSurfaces(Map<String, String> context) {
        ...
        result.put("activationStage", "echomaterialcore_foundation_native_contract_active");
        ...
        result.put("summary", "Baseline raw materials, refined materials, generic building blocks, and material tags.");
        return Map.copyOf(result);
    }

    public static void main(String[] args) {
        Map<String, Object> activation = new EchoMaterialCoreNativeModule()
                .describeNativeSurfaces(Map.of("packId", "echomaterialcore-foundation-smoke"));
        require(Boolean.TRUE.equals(activation.get("activated")),
                "echomaterialcore Foundation native adapter should activate");
        require(Integer.valueOf(CONTRACT_IDS.size()).equals(activation.get("logicalRegistrationCount")),
                "echomaterialcore Foundation native adapter should expose every descriptor contract");
        require(Boolean.FALSE.equals(activation.get("registryMutated")),
                "echomaterialcore Foundation native adapter must not mutate registries");
        System.out.println("echomaterialcore foundation native adapter smoke PASS contracts=" + CONTRACT_IDS.size());
    }
