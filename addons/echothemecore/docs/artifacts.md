# ECHO: ThemeCore Artifact Notes

This file documents the release outputs expected for `echothemecore` version `1.3.0`.
...
| `echothemecore-1.3.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
