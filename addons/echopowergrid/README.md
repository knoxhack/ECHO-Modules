...
Provides `powergrid.blocks`, `powergrid.energy_api`, `powergrid.generators`, `powergrid.grid_status`, `powergrid.storage`, `powergrid.transmission` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echopowergrid` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `tech` |
...
Optional modules: `echoholomap`, `echoindustrialnexus`, `echolens`, `echomultiblockcore`, `echorendercore`, `echoruntimeguard`, `echoterminal`, `echothemecore`, `echoworldcore`

Provides: `powergrid.blocks`, `powergrid.energy_api`, `powergrid.generators`, `powergrid.grid_status`, `powergrid.storage`, `powergrid.transmission`
...
| File | Requirement |
| --- | --- |
| `echopowergrid-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echopowergrid-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echopowergrid-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echopowergrid-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echopowergrid
```
