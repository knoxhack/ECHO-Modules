...
public final class ModBlockEntities {
    private static final Object BLOCK_ENTITY_TYPES =
            EchoBackendRegistryBridge.create(BuiltInRegistries.BLOCK_ENTITY_TYPE, EchoPowerGrid.MODID);

    public static final NativeRegistryHolder<BlockEntityType<GeneratorBlockEntity>> GENERATOR =
        tracked("generator", () -> new BlockEntityType<>(GeneratorBlockEntity::new,
    ...
    public static final NativeRegistryHolder<BlockEntityType<BatteryBlockEntity>> BATTERY =
        tracked("battery", () -> new BlockEntityType<>(BatteryBlockEntity::new,
    ...
    public static final NativeRegistryHolder<BlockEntityType<PowerConsumerBlockEntity>> CONSUMER =
        tracked("consumer", () -> new BlockEntityType<>(PowerConsumerBlockEntity::new,
    ...
    public static final NativeRegistryHolder<BlockEntityType<SubstationBlockEntity>> SUBSTATION =
        tracked("substation", () -> new BlockEntityType<>(SubstationBlockEntity::new,
    ...
    public static void register(Object eventBus) {
        EchoBackendRegistryBridge.registerEventBus(BLOCK_ENTITY_TYPES, eventBus);
    }

    private static <T extends BlockEntityType<?>> NativeRegistryHolder<T> tracked(
            String name, java.util.function.Supplier<? extends T> type) {
        EchoBackendRegistryEntry<T> entry = EchoBackendRegistryBridge.register(BLOCK_ENTITY_TYPES, name, type);
