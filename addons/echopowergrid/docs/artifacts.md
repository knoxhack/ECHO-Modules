# ECHO: PowerGrid Artifact Notes

This file documents the release outputs expected for `echopowergrid` version `1.0.0`.
...
| `echopowergrid-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
