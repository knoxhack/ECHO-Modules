...
Provides `ashfall.content`, `ashfall.missions`, `ashfall.protocol`, `ashfall.survival`, `ashfall.world` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoashfallprotocol` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `pack_root` |
| Role | `official_pack` |
...
Required modules: `echoadaptercore`, `echoblockworks`, `echocore`, `echonetcore`

Optional modules: `echodatacore`, `echoholomap`, `echoindex`, `echolens`, `echomissioncore`, `echonpcore`, `echopresencelink`, `echorendercore`, `echoruntimeguard`, `echosoundcore`, `echoterminal`, `echothemecore`, `echowiki`, `echoworldcore`

Provides: `ashfall.content`, `ashfall.missions`, `ashfall.protocol`, `ashfall.survival`, `ashfall.world`
...
| File | Requirement |
| --- | --- |
| `echoashfallprotocol-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoashfallprotocol-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoashfallprotocol-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoashfallprotocol-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoashfallprotocol
```
