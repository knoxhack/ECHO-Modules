...
public class CrystallineSynthesizerMenu extends AbstractContainerMenu {
    private final CrystallineSynthesizerBlockEntity blockEntity;
    private final ContainerData data;

    public CrystallineSynthesizerMenu(int id, Inventory playerInventory, RegistryFriendlyByteBuf buf) {
        this(id, playerInventory,
                (CrystallineSynthesizerBlockEntity) playerInventory.player.level().getBlockEntity(buf.readBlockPos()),
                new SimpleContainerData(5));
    }

    public CrystallineSynthesizerMenu(int id, Inventory playerInventory, CrystallineSynthesizerBlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRYSTALLINE_SYNTHESIZER.get(), id);
        this.blockEntity = entity;
        this.data = data;
        addDataSlots(data);

        var inv = entity.getInventory();
        this.addSlot(new Slot(inv, CrystallineSynthesizerBlockEntity.INPUT_SLOT_1, 62, 76));
        this.addSlot(new Slot(inv, CrystallineSynthesizerBlockEntity.INPUT_SLOT_2, 62, 118));
        this.addSlot(new Slot(inv, CrystallineSynthesizerBlockEntity.CATALYST_SLOT, 106, 97));
        this.addSlot(new Slot(inv, CrystallineSynthesizerBlockEntity.OUTPUT_SLOT, 244, 97));
        this.addSlot(new BatterySlot(inv, CrystallineSynthesizerBlockEntity.BATTERY_SLOT, 306, 97));
    ...
    public int getCurrentPhase() { return data.get(2); }
