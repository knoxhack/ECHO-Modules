# ECHO Blockworks Artifact Notes

This file documents the release outputs expected for `echoblockworks` version `1.0.0`.
...
| `echoblockworks-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
