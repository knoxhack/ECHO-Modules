# ECHO: WorldCore Artifact Notes

This file documents the release outputs expected for `echoworldcore` version `1.0.0`.
...
| `echoworldcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
