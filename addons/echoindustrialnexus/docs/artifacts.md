# ECHO: Industrial Nexus Artifact Notes

This file documents the release outputs expected for `echoindustrialnexus` version `1.0.0`.
...
| `echoindustrialnexus-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
