...
Provides `industrial.factories`, `industrial.machines`, `industrial.multiblocks`, `industrial.salvage`, `industrial.thermal_flux` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoindustrialnexus` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `tech` |
...
Optional modules: `echoholomap`, `echoindex`, `echolens`, `echologisticsnetwork`, `echomultiblockcore`, `echopowergrid`, `echoterminal`

Provides: `industrial.factories`, `industrial.machines`, `industrial.multiblocks`, `industrial.salvage`, `industrial.thermal_flux`
...
| File | Requirement |
| --- | --- |
| `echoindustrialnexus-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoindustrialnexus-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoindustrialnexus-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoindustrialnexus-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoindustrialnexus
```
