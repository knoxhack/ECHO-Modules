# ECHO: StructureCore Artifact Notes

This file documents the release outputs expected for `echostructurecore` version `1.0.0`.
...
| `echostructurecore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
