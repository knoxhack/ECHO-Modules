...
Provides `structures.discovery_references`, `structures.poi_metadata`, `structures.profiles` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echostructurecore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `structure_core` |
...
Optional modules: `echoholomap`, `echolens`, `echoworldcore`

Provides: `structures.discovery_references`, `structures.poi_metadata`, `structures.profiles`
...
| File | Requirement |
| --- | --- |
| `echostructurecore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echostructurecore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echostructurecore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echostructurecore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echostructurecore
```
