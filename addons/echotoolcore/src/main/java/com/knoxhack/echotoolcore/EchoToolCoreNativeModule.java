...
public final class EchoToolCoreNativeModule implements EchoNativeSurfaceModuleEntrypoint {
    public static final String MODULE_ID = "echotoolcore";
    ...
    public Map<String, Object> describeNativeSurfaces(Map<String, String> context) {
        ...
        result.put("activationStage", "echotoolcore_foundation_native_contract_active");
        ...
        result.put("summary", "Baseline hand tools, tool role tags, and survival tool progression.");
        return Map.copyOf(result);
    }

    public static void main(String[] args) {
        Map<String, Object> activation = new EchoToolCoreNativeModule()
                .describeNativeSurfaces(Map.of("packId", "echotoolcore-foundation-smoke"));
        require(Boolean.TRUE.equals(activation.get("activated")),
                "echotoolcore Foundation native adapter should activate");
        require(Integer.valueOf(CONTRACT_IDS.size()).equals(activation.get("logicalRegistrationCount")),
                "echotoolcore Foundation native adapter should expose every descriptor contract");
        require(Boolean.FALSE.equals(activation.get("registryMutated")),
                "echotoolcore Foundation native adapter must not mutate registries");
        System.out.println("echotoolcore foundation native adapter smoke PASS contracts=" + CONTRACT_IDS.size());
    }
