# ECHO: NotificationCore Artifact Notes

This file documents the release outputs expected for `echonotificationcore` version `1.0.0`.
...
| `echonotificationcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
