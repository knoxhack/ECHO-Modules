# ECHO: NotificationCore

Provides `notifications.mission_updates`, `notifications.system_alerts`, `notifications.toasts`, `notifications.tutorial_hints` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echonotificationcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `notification_core` |
| Side | `common` |
| Trust | `official` |
...
Provides: `notifications.mission_updates`, `notifications.system_alerts`, `notifications.toasts`, `notifications.tutorial_hints`
...
| File | Requirement |
| --- | --- |
| `echonotificationcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echonotificationcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echonotificationcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echonotificationcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echonotificationcore
```
