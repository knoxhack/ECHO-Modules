# ECHO: WeatherCore Artifact Notes

This file documents the release outputs expected for `echoweathercore` version `1.0.0`.
...
| `echoweathercore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
