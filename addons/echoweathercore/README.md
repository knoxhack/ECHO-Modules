...
Provides `weather.countermeasures`, `weather.events`, `weather.forecasts`, `weather.shelters`, `weather.warnings` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoweathercore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `world` |
...
Optional modules: `echoholomap`, `echoindex`, `echosoundcore`, `echoterminal`, `echoworldcore`

Provides: `weather.countermeasures`, `weather.events`, `weather.forecasts`, `weather.shelters`, `weather.warnings`
...
| File | Requirement |
| --- | --- |
| `echoweathercore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoweathercore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoweathercore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoweathercore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoweathercore
```
