# ECHO: Armory Artifact Notes

This file documents the release outputs expected for `echoarmory` version `1.0.0`.
...
| `echoarmory-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
