...
public final class ModCreativeTabs {
   private static final Object CREATIVE_TABS =
      EchoBackendRegistryBridge.create(Registries.CREATIVE_MODE_TAB, EchoArmory.MODID);

   public static final EchoBackendRegistryEntry<CreativeModeTab> ARMORY =
      EchoBackendRegistryBridge.register(CREATIVE_TABS, "armory", () -> CreativeModeTab.builder()
