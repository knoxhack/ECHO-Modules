# ECHO: ScriptCore Artifact Notes

This file documents the release outputs expected for `echoscriptcore` version `1.0.0`.
...
| `echoscriptcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
