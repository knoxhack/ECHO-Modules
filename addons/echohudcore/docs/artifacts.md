# ECHO: HUDCore Artifact Notes

This file documents the release outputs expected for `echohudcore` version `1.0.0`.
...
| `echohudcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
