...
Provides `hud.compass_indicators`, `hud.hazard_meters`, `hud.mission_tracker`, `hud.safe_area`, `hud.widgets` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echohudcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `hud_core` |
...
Provides: `hud.compass_indicators`, `hud.hazard_meters`, `hud.mission_tracker`, `hud.safe_area`, `hud.widgets`
...
| File | Requirement |
| --- | --- |
| `echohudcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echohudcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echohudcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echohudcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echohudcore
```
