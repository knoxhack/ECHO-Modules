# ECHO: ValidationCore Artifact Notes

This file documents the release outputs expected for `echovalidationcore` version `1.0.0`.
...
| `echovalidationcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
