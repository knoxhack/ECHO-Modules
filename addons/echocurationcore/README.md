...
Launcher and Studio recommendations for module fit, bundle previews, dependency explanations, and readiness badges.
...
- MVP contracts: `recommended_modules_report`, `bundle_preview_contract`, `readiness_badges`
