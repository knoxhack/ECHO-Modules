...
Provides `arcana.aetherworks`, `arcana.aether_machines`, `arcana.aether_storage` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoaetherworks` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `addon` |
| Role | `story` |
...
Optional modules: `echocursecore`, `echorelictech`, `echoritualcore`, `echospellcore`

Provides: `arcana.aetherworks`, `arcana.aether_machines`, `arcana.aether_storage`

Consumes: `arcana.aether`, `arcana.core`, `echo.core`
...
| File | Requirement |
| --- | --- |
| `echoaetherworks-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoaetherworks-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoaetherworks-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoaetherworks-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
...
```sh
node scripts/generate-module-release.mjs --module echoaetherworks
```
