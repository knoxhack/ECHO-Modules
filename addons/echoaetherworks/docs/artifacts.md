# ECHO: AetherWorks Artifact Notes

This file documents the release outputs expected for `echoaetherworks` version `1.0.0`.
...
| `echoaetherworks-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
