...
Provides `platform.contracts` for the ECHO module graph.

## Module Identity

| Field | Value |
| --- | --- |
| Module ID | `echoplatformcore` |
| Version | `1.0.0` |
| Type | `addon` |
| Kind | `library` |
| Role | `platform` |
...
```sh
node scripts/generate-module-release.mjs --module echoplatformcore
```
