# ECHO: PlatformCore Artifact Notes

This file documents the release outputs expected for `echoplatformcore` version `1.0.0`.

## Artifact Matrix

| File | Requirement |
| --- | --- |
| `echoplatformcore-1.0.0-neoforge.jar` | Required for Ashfall NeoForge Edition. |
| `echoplatformcore-1.0.0.echo-addon` | Required for Ashfall Native Edition. |
| `echoplatformcore-1.0.0-standalone.jar` | Required for Ashfall Standalone Edition. |
| `echoplatformcore-1.0.0-sources.jar` | Always required for traceability and developer debugging. |
| `echoplatformcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
