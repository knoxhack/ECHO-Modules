...
public final class EchoStationCoreNativeModule implements EchoNativeSurfaceModuleEntrypoint {
    public static final String MODULE_ID = "echostationcore";
    ...
    public Map<String, Object> describeNativeSurfaces(Map<String, String> context) {
        ...
        result.put("activationStage", "echostationcore_foundation_native_contract_active");
        ...
        result.put("summary", "Baseline crafting/storage/processing stations and recipe surface contracts.");
        return Map.copyOf(result);
    }

    public static void main(String[] args) {
        Map<String, Object> activation = new EchoStationCoreNativeModule()
                .describeNativeSurfaces(Map.of("packId", "echostationcore-foundation-smoke"));
        require(Boolean.TRUE.equals(activation.get("activated")),
                "echostationcore Foundation native adapter should activate");
        require(Integer.valueOf(CONTRACT_IDS.size()).equals(activation.get("logicalRegistrationCount")),
                "echostationcore Foundation native adapter should expose every descriptor contract");
        require(Boolean.FALSE.equals(activation.get("registryMutated")),
                "echostationcore Foundation native adapter must not mutate registries");
        System.out.println("echostationcore foundation native adapter smoke PASS contracts=" + CONTRACT_IDS.size());
    }
