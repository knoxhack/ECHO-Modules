# ECHO Creature Roles Artifact Notes

This file documents the release outputs expected for `echocreatureroles`
version `0.1.0`.
...
| File | Requirement |
| --- | --- |
| `echocreatureroles-0.1.0-neoforge.jar` | Required for ECHO NeoForge editions. |
...
- `META-INF/echo.mod.json` is the cross-runtime descriptor and must match the released module ID, version, dependency contracts, and foundation creature role namespaces.
...
Launcher modpack updates treat ECHO Creature Roles as an individual managed
