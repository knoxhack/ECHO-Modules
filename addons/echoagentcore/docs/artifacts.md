# ECHO: AgentCore Artifact Notes

This file documents the release outputs expected for `echoagentcore` version `1.0.0`.
...
| `echoagentcore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
