# ECHO: PowerCore Artifact Notes

This file documents the release outputs expected for `echopowercore` version `1.0.0`.
...
| `echopowercore-1.0.0-content-graph.json` | Required; Release-Index catalogable sidecar containing the canonical `.ECHO Content Graph`. |
