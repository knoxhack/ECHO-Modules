...
export async function validateContentGraph({ strict = false, moduleIds = [] } = {}) {
...
if (options.help) {
  console.log('Usage: node scripts/validate-content-graph.mjs [--strict] [--module id1,id2]')
  process.exit(0)
}

validateContentGraph({ strict: options.strict, moduleIds: options.moduleIds })
  .then((result) => {
